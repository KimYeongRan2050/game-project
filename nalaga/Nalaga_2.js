...
function startGame() {
  ...
  audioFiles.beforeStart.play().catch(err => {
    console.log("BGM autoplay blocked, will resume on Enter key.");
  });
}
...
function startPlaying() {
 ...
 audioFiles.gameBGM.play().catch(err => {
    console.log("Play failed again:", err);
  });
}
